...
/**
 * @brief Check if one KmerFreq is greater than other
 * @param first is a KmerFreq that is about to be check if is greater. Input parameter
 * @param second is a KmerFreq that is about to be check if is smaller. Input parameter
 * @return return if first is greater than second.
 */
bool greaterKmerFreq(const KmerFreq& first, const KmerFreq& second);
    
/**
 * @brief Check if two KmerFreq are the same
 * @param first is a KmerFreq that is about to be check if is the same. Input parameter
 * @param second is the other KmerFreq that is about to be check if is the same. Input parameter
 * @return return if first is greater than second.
 */
